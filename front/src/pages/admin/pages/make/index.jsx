...
export default function CategoryMenu() {
    const [categories, setCategories] = useState([
        { id: 1, category: "Vehicle", title: "Car", date: "2024-04-25", status: "Active" },
        { id: 2, category: "Vehicle", title: "Bike", date: "2024-04-24", status: "Inactive" },
        { id: 3, category: "Heavy Vehicle", title: "Truck", date: "2024-04-23", status: "Active" },
        { id: 4, category: "Public Transport", title: "Bus", date: "2024-04-22", status: "Active" },
    ]);
            ...
            <div className="d-flex justify-content-between align-items-center px-4 py-3 border-bottom" style={{ background: "#fff", borderTop: "3px solid #03a9f4" }}>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mb-0 small">
                        ...
                        <li className="breadcrumb-item active text-primary">Make</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div className="table-responsive">
                            <table className="table table-hover align-middle mb-0">
                                <thead className="table-light text-uppercase text-secondary small">
                                    <tr>
                                        {["Category", "Title", "Date", "Status", "Actions"].map(col => (
                                ...
                                <tbody>
                                    {displayedCategories.map(({ id, category, title, date, status }) => (
                                        <tr key={id}>
                                            <td>{category}</td>
                                            <td>{title}</td>
                                            <td>{date}</td>
