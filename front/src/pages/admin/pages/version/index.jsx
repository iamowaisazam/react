...
export default function CategoryMenu() {
    const [categories, setCategories] = useState([
        { id: 1, category: "Vehicle", make: "Vehicle", model: "Toyota", title: "Car", date: "2024-04-25", status: "Active" },
        { id: 2, category: "Vehicle", make: "Vehicle", model: "Yaris", title: "Bike", date: "2024-04-24", status: "Inactive" },
        { id: 3, category: "Heavy Vehicle", make: "Vehicle", model: "Honda", title: "Truck", date: "2024-04-23", status: "Active" },
        { id: 4, category: "Public Transport", make: "Vehicle", model: "BMW", title: "Bus", date: "2024-04-22", status: "Active" },
    ]);
                        ...
                        <div className="table-responsive">
                            <table className="table table-hover align-middle mb-0">
                                <thead className="table-light text-uppercase text-secondary small">
                                    <tr>
                                        {["Category", "make", "model", "Title", "Date", "Status", "Actions"].map(col => (
                                ...
                                <tbody>
                                    {displayedCategories.map(({ id, category, title, date, status, make, model }) => (
                                        <tr key={id}>
                                            <td>{category}</td>
                                            <td>{make}</td>
                                            <td>{model}</td>
