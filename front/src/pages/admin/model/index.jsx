...
import { getModel, deleteModel } from './modelFeature';
    ...
    return (
        <main>
            ...
            >
                ...
                <Link to="/admin/add-model" className="admin_add_btn">
                                        ...
                                        state.loading ? (
                                            ...
                                            data.map((make, index) => (
                                                <tr key={make._id}>
                                                    ...
                                                    <td>{make.makeId?.name || 'N/A'}</td>
                                                    <td>
                                                        <div className="d-flex gap-2">
                                                            <button
                                                                className="btn btn-sm btn-outline-primary"
                                                                onClick={() => navigate(`/admin/edit-model/${make._id}`)}
                                                            >
                                                                ✎ Edit
                                                            </button>
                                                            <button
